          ...
          {!file ? (
            ...
            <div className="w-full max-w-2xl flex flex-col gap-6 mt-8">
              <div className="text-center flex flex-col gap-2">
                <h2 className="text-2xl font-extrabold tracking-tight text-neo-text">
                  Unggah Gambar OCR
                </h2>
                <p className="text-sm text-neo-muted max-w-md mx-auto leading-relaxed">
                  Ekstrak teks dari sertifikat, buku, dokumen, KTP, screenshot, atau foto outdoor secara instan.
                </p>
              </div>
